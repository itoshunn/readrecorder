 ...
 *
 */
class ReadsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'read_flag' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
    ...
    public $records = [
        [
            ...
            'finish_date' => '2016-12-04',
            'read_flag' => 1,
            'created' => '2016-12-04 05:48:11',
            'modified' => '2016-12-04 05:48:11'
        ],
    ];
}
