<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Read Log'), ['action' => 'edit', $readLog->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Read Log'), ['action' => 'delete', $readLog->id], ['confirm' => __('Are you sure you want to delete # {0}?', $readLog->id)]) ?> </li>
